...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { section_id: @enrollment.section_id, session_id: @enrollment.session_id, student_number: @enrollment.student_number }
    end
  ...
  test "should update enrollment" do
    patch :update, id: @enrollment, enrollment: { section_id: @enrollment.section_id, session_id: @enrollment.session_id, student_number: @enrollment.student_number }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
